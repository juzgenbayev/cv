...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[Ph.D.] \tab{}Political Science, Northwestern University, 2028 (expected)
        \item[J.D.] \tab{}Pritzker School of Law, Northwestern University, 2028 (expected)
   ...
   \begin{tablist}
        ...
        \item[2026] \tab{}A. Juzgenbayev. \enquote{The Vanishing Enforcer: Consumer Protection in an Era of Dual Retrenchment.} \textit{Northwestern University Law Review}, Volume 120, Issue 5, 2026, pp.~1449. \href{https://scholarlycommons.law.northwestern.edu/nulr/vol120/iss5/6}{link}
   ...
   \begin{tablist}
    ...
    \begin{tablist}
        \item[2026] \tab{}\enquote{Politics, Power, and Access to Justice.} Association of Law and Political Economy (ALPE) Conference. Richmond, Virginia. Feb. 6--7.
    \end{tablist}

    \subsection*{Conference Presentations}

    \begin{tablist}
        \item[2026] \tab{}A. Juzgenbayev. \enquote{Administrative Courts and the Politics of Legal Reform in Kazakhstan.} American Political Science Association (APSA) Annual Meeting. Poster presentation. Boston, Massachusetts. Sep. 3--6.
        \item[2026] \tab{}A. Juzgenbayev. \enquote{Pedagogical Courts: Judicial Recruitment, Agency Deference, and Administrative Justice in Kazakhstan.} International Society of Public Law (ICON-S) Annual Conference. University College Dublin. Dublin, Ireland. Jun. 29--Jul. 1.
        \item[2026] \tab{}A. Juzgenbayev. \enquote{Teaching the State: Administrative Courts and Legal Reform in Kazakhstan.} Central Eurasian Studies Society (CESS) Regional Conference. Nazarbayev University. Astana, Kazakhstan. Jun. 16--19.
        \item[2026] \tab{}A. Juzgenbayev. \enquote{Formation of Administrative Justice in Kazakhstan: The Role of Laterally Recruited Judges.} Conference ``Development of Administrative Justice in Light of the New Constitution.'' Narxoz University. Almaty, Kazakhstan. Jun. 12.
        \item[2026] \tab{}A. Juzgenbayev. \enquote{Administrative Courts and the Politics of Legal Reform in Kazakhstan.} 4th Conference ``New Advances in the Political Economy of Development in Eurasia.'' Almaty Management University. Almaty, Kazakhstan. Jun. 4--6.
        ...
        \item[2025] \tab{}A. Juzgenbayev. \enquote{Administrative Justice and Regime Support in Kazakhstan: How Institutional Remedies Shape Citizen Perceptions.} Law and Society Association (LSA) Annual Meeting. Chicago, Illinois. May 22--25.
        \item[2025] \tab{}V. Umanets, Y. Khalikova, Marcy S. (Presenter), A. Juzgenbayev. \enquote{Impact of High-Profile Cases on Public Perception of Domestic Violence: Identity-Based Dynamics in Kazakhstan.} Midwest Political Science Association (MPSA) Annual Conference. Chicago, Illinois. Apr. 3--6.

        \item[2023] \tab{}A. Juzgenbayev. \enquote{Populist Frames and Judicial Legitimacy: Survey Experiment in Czech Republic.} European Consortium for Political Research (ECPR) General Conference. Prague, Czechia. Sep. 4--8.

        \item[2022] \tab{}A. Trochev \& A. Juzgenbayev. \enquote{Clientelism, Constitutional Courts, and High Politics in Central Asian Countries.} Association for Slavic, East European, and Eurasian Studies (ASEEES) Convention. Chicago, Illinois. Nov. 10--13.
    ...
    \begin{tablist}
        \item[2026--28] \tab{}American Bar Foundation/Northwestern University, Doctoral Fellowship in Law and Social Science
        \item[2025--27] \tab{}Northwestern University, Presidential Fellowship ($\sim$ 12\% acceptance rate)
        \item[2019] \tab{}University of Wisconsin-Madison, Visiting International Students Program (VISP) (\$14,500)
    \end{tablist}
